...
jQuery(function ($) {
    ...
    (function () {
        var myLatlng = new google.maps.LatLng(-37.9876884, -57.5579365);
    ...
    // ----------------------------------------
    // CALCULO AÑO Y EDAD - MOMENTS
    // ----------------------------------------

    (function(){
        moment().format();
        var now = moment();
        var miFecha = moment("1990-06-09")
        var anios = now.diff(miFecha,"Years");

        $("#miEdad").html(anios);
        $("#year").html(now.format("Y"));
    }());
    ...
    var opciones = {
        strings: [
                 ...
                 "Desarrollador ^1000 Frontend.",
                 "Desarrollador ^1000 <b>Web</b>."
        ],
        typeSpeed: 30,
        backSpeed: 30,
    }

    var typed = new Typed('.type', opciones);
